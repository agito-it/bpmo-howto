...
@BPMOApplication
@ProcessApplication("BPMOHowtoHelloWorldApplication")
public class HelloBPMOProcessApplication extends ServletProcessApplication implements BPMOApplicationInterface {
