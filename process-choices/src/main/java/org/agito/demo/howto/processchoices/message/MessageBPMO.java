...
/**
 * Enum for MessageBPMO.
 *
 * @author andreas.weise
 */
public enum MessageBPMO implements IBODataElement {

	;
	/**
	 * <b>BPMO Identifier</b>
	 */
	public final static IBOId $BPMO = new IBOId.BOId("MessageBPMO");

	/**
	 * <b>Node Identifier</b>
	 */
	public final static IBONode $ID = new IBONode.BONode("MessageBPMO", "MessageBPMO", ControlType.DEFAULT);

	private final static IEnumInspector ENUM_INSPECTOR = DataTypeFactory.getInstance().createEnumInspector(MessageBPMO.class);
	private MessageBPMO(String id, String path, ControlType controlType) { this.id = id; this.path = path; this.controlType = controlType; }
	private String id;
